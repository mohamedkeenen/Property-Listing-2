...
export const mapBackendPropertyToFrontend = (p: any): PropertyListing => {
  ...
  return {
    ...
    propqa_lat: p.propqa_lat || null,
    propqa_lng: p.propqa_lng || null,
    propqa_emirate: p.propqa_emirate || "",
    propqa_city: p.propqa_city || "",
    propqa_community: p.propqa_community || "",
    propqa_sub_community: p.propqa_sub_community || "",
    propqa_tower: p.propqa_tower || "",
...
export const mapBackendPropertyToFormValues = (p: any): any => {
  ...
  return {
    ...
    propqa_location_id: p.propqa_location_id || "",
    propqaLocationName: p.propqa_location_name || "",
    propqa_lat: p.propqa_lat || "",
    propqa_lng: p.propqa_lng || "",
    propqa_emirate: p.propqa_emirate || "",
    propqa_city: p.propqa_city || "",
    propqa_community: p.propqa_community || "",
    propqa_sub_community: p.propqa_sub_community || "",
