...
export default function CreateListingPage() {
  ...
  const handleNext = async () => {
    ...
    if (currentStep === 0) {
      fieldsToValidate = ["category", "purpose", "type", "unitNo", "bedrooms", "bathrooms", "price", "title", "listingAgent"];
    } else if (currentStep === 2) {
      fieldsToValidate = ["city", "community"];
    }
        ...
        <div className="max-w-[1600px] mx-auto px-4 md:px-8">
          ...
          <div className="flex items-center justify-between py-6">
            ...
            <div className="flex items-center gap-4">
              <Button variant="ghost" className="h-11 rounded-[1.25rem] font-black text-[10px] uppercase tracking-widest text-muted-foreground hover:text-foreground dark:hover:text-white hover:bg-muted dark:hover:bg-white/5 transition-all px-8">
                Discard Changes
              </Button>
              <Button variant="outline" className="h-11 rounded-[1.25rem] border-border/40 bg-transparent text-foreground dark:text-white font-black text-[10px] uppercase tracking-widest px-10 hover:bg-muted dark:hover:bg-white/5 transition-all shadow-xs gap-2">
